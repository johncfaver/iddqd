...
<div id="div_main">
	...
	<div id="helpcontent_inserting" class="help_content"> 
		...
		<ul>
			...
			<li><b>Enter or edit the new data.</b></li>Replace old data, delete old data, or insert new data by editing fields and using the +/- icons. Data can only be modified by the original author. 
		</ul>
	</div>
	<div id="helpcontent_drawing" class="help_content">
		<br/>Drawing works a lot like other structure drawing programs, and is mostly straightforward. Here are some tips:
		<ul>
	...
	<div id="helpcontent_viewing" class="help_content">
		...
		<ul><li>The <i>Binding</i> tab shows binding data, with each row consisting of data type, value, target, and comment. 
			...
			<li>The <i>Document</i> tab lists the various documents users have uploaded concerning the molecule. 
				These could be manuscripts, synethetic schemes, spectra, or anything else relevant to the compound.</li>
