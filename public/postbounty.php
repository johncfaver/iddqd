...
?>
    ...
    <div id="div_datainput">
        <form id="datainput" enctype="multipart/form-data" action="../cgi-bin/uploadbounty.py" method="post">
        <div id="target_select">
            Target:&nbsp;&nbsp;&nbsp;
            <select id="select_targetid" name="select_targetid">
<?php
...
?>
        ...
        <div id="div_postbounty_notes">
            Notes about this bounty:
            <br/><br/>
            <textarea id="molnotes" name="molnotes" rows="5" cols="40" ></textarea>
        </div>
