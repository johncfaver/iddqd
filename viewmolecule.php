<?php
	...
	$q = $dbconn->prepare("SELECT m.molname,m.authorid,u.username,m.dateadded,m.molweight,m.molformula,m.iupac,m.cas FROM molecules m,users u where m.molid=:num and m.authorid=u.userid");
